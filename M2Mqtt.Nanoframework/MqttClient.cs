...
#if NANOFRAMEWORK
using M2Mqtt.Nanoframework.TimeHelper;
...
#endif
        {
#if !(MF_FRAMEWORK_VERSION_V4_2 || MF_FRAMEWORK_VERSION_V4_3 || COMPACT_FRAMEWORK || WINDOWS_APP || WINDOWS_PHONE_APP || NANOFRAMEWORK)
